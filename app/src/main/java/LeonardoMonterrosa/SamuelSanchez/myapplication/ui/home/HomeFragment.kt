...
import LeonardoMonterrosa.SamuelSanchez.myapplication.PacienteDetalleActivity
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fun obtenerPacientes(): List<tbPacientes> {
            ...
            while (resulSet?.next() == true) {
                ...
                val valoresJuntos = tbPacientes(
                    idPaciente, nombre, apellido, edad, enfermadad,
                    numero_habitacion, numero_cama, medicamentos_asignados,
                    fecha_nacimiento, hora_aplicacion_medicamento
                )
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                val adapter = AdaptadorPaciente(pacientesDB) { paciente ->
                    val intent = Intent(requireContext(), PacienteDetalleActivity::class.java)
